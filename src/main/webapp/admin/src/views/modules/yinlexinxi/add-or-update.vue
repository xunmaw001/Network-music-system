      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="编曲" prop="bianqu">
          <el-input v-model="ruleForm.bianqu" 
              placeholder="编曲" clearable  :readonly="ro.bianqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="编曲" prop="bianqu">
              <el-input v-model="ruleForm.bianqu" 
                placeholder="编曲" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="填词" prop="tianci">
          <el-input v-model="ruleForm.tianci" 
              placeholder="填词" clearable  :readonly="ro.tianci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="填词" prop="tianci">
              <el-input v-model="ruleForm.tianci" 
                placeholder="填词" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
