...
public class DiscussgedanxinxiController {
    ...
    public R save(@RequestBody DiscussgedanxinxiEntity discussgedanxinxi, HttpServletRequest request){
    	discussgedanxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussgedanxinxiEntity> wrapper = new EntityWrapper<DiscussgedanxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussgedanxinxiService.selectCount(wrapper);
